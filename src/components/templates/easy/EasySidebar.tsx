...
import { IconChanges, IconHistory, IconBranch, IconRemote, IconGit, IconSettings, IconSubmodule } from "../../atoms/icons";
import { AppVersion } from "../../atoms/AppVersion";

const NAV_IDS: { id: ActiveView; key: string; Icon: React.FC<{ className?: string }> }[] = [
  { id: "changes",    key: "easy.sidebar.changes",  Icon: IconChanges  },
  { id: "history",    key: "easy.sidebar.history",  Icon: IconHistory  },
  { id: "branches",   key: "easy.sidebar.branches", Icon: IconBranch   },
  { id: "remotes",    key: "sidebar.remotes",        Icon: IconRemote   },
  { id: "submodules", key: "sidebar.submodules",     Icon: IconSubmodule },
];

export function EasySidebar() {
