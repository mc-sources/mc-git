...
pub fn rename_branch(
    ...
    log_result(
        &app,
        &format!("rename_branch({old_name} → {new_name})"),
        result,
    )
}
...
pub fn checkout_remote_branch(
    ...
    log_result(
        &app,
        &format!("checkout_remote_branch({remote_branch_name})"),
        result,
    )
}
...
pub fn set_branch_upstream(
    ...
    log_result(
        &app,
        &format!("set_branch_upstream({branch_name} → {upstream})"),
        result,
    )
}
...
pub fn unset_branch_upstream(
    ...
    log_result(
        &app,
        &format!("unset_branch_upstream({branch_name})"),
        result,
    )
}
